# The list of services on the local computer is read into
# the variable $services
$services=Get-Service

# A foreach loop cycles through all of the service in
# the $services variable. During each iteration of the loop
# the variable $s represents the individual item being evaluated
...
# MIIgWgYJKoZIhvcNAQcCoIIgSzCCIEcCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUybXal8GaSKfAWqFurIdmmDnr
# 1TOgghsfMIIEwzCCA6ugAwIBAgITMwAAAHeHqQZ/e88wOQAAAAAAdzANBgkqhkiG
...
# b4kLfchpyOZu6qeXzjEp/w7FW1zYTRuh2Povnj8uVRZryROj/TGCBKUwggShAgEB
...
# AAEKMAkGBSsOAwIaBQCggb4wGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwHAYK
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFH1OGdxD
# QME3SwiHN2p4inVxGFHQMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwByAG8A
# cwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jvc29m
# dC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAIkNSTNIhIhsKITB+J6k
# +5rJg7S/GFzLko3FODTpyMcoPvbENrhRTJqb32iZalkLzo2hxwF2FfyW+pz+5pBy
# +6nxqj2dhYDW4cyBnDJCQ+IfKEWutW0RnXnJ68mhc9jdFcyLB/+IlsZB8FPZnPuN
# olvISmy5K+ixfYJZy+YnkNTGrADxsVjV2Z6yzmQScHHmd3Xr0ennYqMcq8CYuK9Z
# PDEMAwGYr3mmoyPRoVOdxPRRPJOt+zBNFc44OYjxZfv06505VccFQ+NWhs9us6QD
# 6pTecdO/7UZ+XwI8biorgryieFylmX8smOOgOuhUB3cLxJVqS8LR3WqbIAVwR2l4
# FKKhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UEBhMC
# VVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNV
# BAoTFU1pY3Jvc29mdCBDb3Jwb3JhdGlvbjEhMB8GA1UEAxMYTWljcm9zb2Z0IFRp
# bWUtU3RhbXAgUENBAhMzAAAAd4epBn97zzA5AAAAAAB3MAkGBSsOAwIaBQCgXTAY
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xNTA4MjUx
# NjA1NDVaMCMGCSqGSIb3DQEJBDEWBBQoEYIAtfxLpZ3r4bSAwa9y9BCqhzANBgkq
# hkiG9w0BAQUFAASCAQCwccj44yTWJvC7l1Hv7F6PjKcWAdri22utbeeXmMFGLHG4
# xTsz3pwsz1FA/+o52IIRR/bkuvBf2MFGAD9V2ryWI9LIaiYPibFw0GQSZzA2Y8W1
# 0xyDL9uHGZs0lCvauP21d64vY4XW2KmF295DrmdC4DwfZWSluVZITOAS6wayloW6
# A3Yo5U0J7/34reftg44V5TTEjpTYYR/iueP+mQNlE2HFu5e4BXz8XbXLamwGJrdx
# naB4dN4Xf5Q4zMJDoOj8uukpPYEav9oyYnxGWSmsbi05wXb6Uql+T7kc+tupr7+J
# sKgqTGN7KfJQaJJ9jeDwi1gmeqxFh8GHMrLXkz9L
