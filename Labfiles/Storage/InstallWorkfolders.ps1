...
New-GPLink -Name "Work Folders" -Target "OU=Marketing,DC=Adatum,DC=com"
New-WebBinding -Name "Default Web Site" -IP "*" -Port 443 -Protocol https
Import-Module WebAdministration
Set-Location IIS:\SslBindings
Get-ChildItem cert:\LocalMachine\MY | Where-Object {$_.Subject -match "CN=lon-dc1.adatum.com"} | Select-Object -First 1 | New-Item 0.0.0.0!443

# SIG # Begin signature block
# MIIgWgYJKoZIhvcNAQcCoIIgSzCCIEcCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUmoN/vvhFGr6U0KLV2nVCr3YA
# OHKgghsfMIIEwzCCA6ugAwIBAgITMwAAAHp9lu0XI96URAAAAAAAejANBgkqhkiG
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFIIEFqR1
# 5kYfvfS5cX7gf9MPuDDMMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwByAG8A
# cwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jvc29m
# dC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAC/DY8wK4XOv2bAUv0/n
# gvFXpa//2NWeERy2wEzmphWsFi04yBK4iwdCft1fvY25XnfWS+ulrcsLT6yyW151
# cuDNhMX2gZJAs9vSaadbgX/up1jfuIT6BOZY5GAK9Wvtaw5z80oQz1GmVR7i8Kcn
# CYcUna6ByTeCM5klqWGZovPZwtyDJN/5PmflTMoUNPInlqmz9OIDgvbr/4Axyakm
# fmDTGbLKQO84uN01Y7RgN3vg5eSTFZirqRlgHWIXifb9WfVYRnKCOXWqbGMEea9K
# 2x6XOwzjvBdZDz7HMhwano9nBUaf8XbpYh5cyviSNWsKiJzfEMmCUHsFWZaaz1lY
# gJmhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UEBhMC
# VVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNV
# BAoTFU1pY3Jvc29mdCBDb3Jwb3JhdGlvbjEhMB8GA1UEAxMYTWljcm9zb2Z0IFRp
# bWUtU3RhbXAgUENBAhMzAAAAen2W7Rcj3pREAAAAAAB6MAkGBSsOAwIaBQCgXTAY
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xNTA4MjMw
# ODE2MTJaMCMGCSqGSIb3DQEJBDEWBBRmU2WsLHYWfH1rnz2d9nfp15QNPjANBgkq
# hkiG9w0BAQUFAASCAQB6V2Y+ED/SK5WxNTf0MlaCvl3vFvhgPpCkhElh78HqPBKi
# lPJlfDnxl1xIyuTEwfa7Xfy7jSVinKk8n/7clE+7aCAzc/3+9A5tQ3DgRcL3ZpYG
# +RoTnPdlNMiSRhaokWb5udJQpSj1taxVJrXc5dD3UYji4emZ07dEVb+EwPS+iCDJ
# N6AtOZla7vHi4j65EOasx4UjemL2mUEPeA3VnZ33Gj3AuTOTTmCmA+g4OpzX+pQr
# b1wwBsu/+a1EaQx1KE71bKY4ESF7OtZ34UrXhZEZ5Z0AQiR+qz41K+u97YC6wlxN
# rd2W8VWOGrj0HQrV3DiAvoaFsufa82PUrR5cmpOV
